...
class Collection(models.Model):
    ...
    featured_food = models.ForeignKey('Food', on_delete=models.SET_NULL, null=True,related_name='+')
...
class Food(models.Model):
    ...
    collection = models.ForeignKey(Collection, on_delete=models.SET_NULL, null=True, related_name='food')
